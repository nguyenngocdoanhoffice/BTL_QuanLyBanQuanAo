...
@section('content')
    <section class="max-w-3xl mx-auto px-4 py-16">
        <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-8">
            <h1 class="text-3xl font-semibold tracking-tight">Chào mừng quay lại</h1>
            <p class="mt-2 text-slate-500">Đăng nhập để quản lý đơn hàng và theo dõi mua sắm của bạn.</p>
            ...
            <form action="{{ route('login') }}" method="POST" class="mt-8 space-y-6">
                ...
                <div class="flex items-center justify-between text-sm">
                    ...
                    <a href="{{ route('register') }}" class="font-medium text-slate-900">Chưa có tài khoản?</a>
                </div>
                <button type="submit" class="w-full rounded-2xl bg-slate-900 px-6 py-3 text-white font-semibold">Đăng nhập</button>
            </form>
        </div>
    </section>
@endsection
